...
export function FairSynthHeader() {
  ...
  return (
    <header className="pointer-events-none fixed left-1/2 top-4 z-40 w-full -translate-x-1/2 px-4">
      <nav className="pointer-events-auto mx-auto flex w-fit items-center gap-1 rounded-full border border-[#FED9B7] bg-white/55 px-2 py-2 shadow-[0_18px_40px_rgba(0,129,167,0.10)] backdrop-blur-xl">
          {links.map((link) => {
            ...
            return (
              ...
              >
                ...
                <span className="pointer-events-none absolute top-full mt-2 rounded-full bg-[#0081A7] px-3 py-1 text-[11px] font-semibold text-[#FDFCDC] opacity-0 shadow-lg transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
                  {link.label}
                </span>
              </Link>
            )
